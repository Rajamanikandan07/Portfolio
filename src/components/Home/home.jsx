...
import resume from '../../assets/Rajamanikandan resume.pdf';
        ...
        <>
            <div className="home-overall" id='home-page'>
                <div className="user-info-box">
                    ...
                    <br />
                    <a href={resume} download='Rajamanikandan.pdf' target='_blank'><button className='resume-btn'>Resume</button></a>
                </div>
